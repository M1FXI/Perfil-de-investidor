...
import com.example.perfildeinvestidor.databinding.FragmentFourthQuestionBinding


class FourthQuestionFragment : Fragment() {

    private var binding: FragmentFourthQuestionBinding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentFourthQuestionBinding.inflate(inflater, container, false)
    ...
    fun goToNextScreen(questionIndex: Int) {
        ...
        findNavController().navigate(R.id.action_fourthQuestionFragment_to_fifthQuestionFragment)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    ...
                    findNavController().navigate(R.id.action_fourthQuestionFragment_to_thirdQuestionFragment)
                }
            }
