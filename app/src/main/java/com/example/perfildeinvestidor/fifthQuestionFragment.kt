...
import com.example.perfildeinvestidor.databinding.FragmentFifthQuestionBinding


class FifthQuestionFragment : Fragment() {

    private var binding: FragmentFifthQuestionBinding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentFifthQuestionBinding.inflate(inflater, container, false)
    ...
    fun goToNextScreen(questionIndex: Int) {
        ...
        findNavController().navigate(R.id.action_fifthQuestionFragment_to_sixthQuestionFragment)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    ...
                    findNavController().navigate(R.id.action_fifthQuestionFragment_to_fourthQuestionFragment)
                }
            }
