...
import com.example.perfildeinvestidor.databinding.FragmentFirstQuestionBinding
...
class FirstQuestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentFirstQuestionBinding.inflate(inflater, container, false)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    sharedViewModel.resetName()
                    sharedViewModel.removeLastScore()
                    findNavController().navigate(R.id.action_firstQuestionFragment_to_startFragment)
                }
            }
