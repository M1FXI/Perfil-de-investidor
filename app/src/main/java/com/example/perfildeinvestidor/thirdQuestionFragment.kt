...
import com.example.perfildeinvestidor.databinding.FragmentThirdQuestionBinding
...
class ThirdQuestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentThirdQuestionBinding.inflate(inflater, container, false)
    ...
    fun goToNextScreen(questionIndex: Int) {
        ...
        findNavController().navigate(R.id.action_thirdQuestionFragment_to_fourthQuestionFragment)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    ...
                    findNavController().navigate(R.id.action_thirdQuestionFragment_to_secondQuestionFragment)
                }
            }
