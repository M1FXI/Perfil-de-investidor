...
import com.example.perfildeinvestidor.databinding.FragmentSixthQuestionBinding


class SixthQuestionFragment : Fragment() {

    private var binding: FragmentSixthQuestionBinding? = null
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentSixthQuestionBinding.inflate(inflater, container, false)
    ...
    fun goToNextScreen(questionIndex: Int) {
        ...
        findNavController().navigate(R.id.action_sixthQuestionFragment_to_seventhQuestionFragment)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    ...
                    findNavController().navigate(R.id.action_sixthQuestionFragment_to_fifthQuestionFragment)
                }
            }
