...
import com.example.perfildeinvestidor.databinding.FragmentSecondQuestionBinding
...
class SecondQuestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = FragmentSecondQuestionBinding.inflate(inflater, container, false)
        ...
        val callback: OnBackPressedCallback =
            object : OnBackPressedCallback(true)
            {
                override fun handleOnBackPressed() {
                    ...
                    findNavController().navigate(R.id.action_secondQuestionFragment_to_firstQuestionFragment)
                }
            }
